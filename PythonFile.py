...
years_df, countries_df = process_co2_data('API_EN.ATM.CO2E.PP.GD_DS2_en_csv_v2_4904492.csv')
print(years_df)
print(countries_df)
...
# Load the data
df = pd.read_csv('API_EN.ATM.CO2E.PP.GD_DS2_en_csv_v2_4904492.csv', skiprows=4)
...
df_CO2GDP = pd.read_csv('API_EN.ATM.CO2E.PP.GD_DS2_en_csv_v2_4904492.csv', skiprows=4)
df_forest = pd.read_csv('API_AG.LND.FRST.ZS_DS2_en_csv_v2_5358376.csv', skiprows=4)
df_renewableElectricity = pd.read_csv('API_EG.FEC.RNEW.ZS_DS2_en_csv_v2_5359592.csv', skiprows=4)
df_energyUse = pd.read_csv('API_EG.USE.PCAP.KG.OE_DS2_en_csv_v2_5358565.csv', skiprows=4)
df_population = pd.read_csv('API_SP.POP.TOTL_DS2_en_csv_v2_5358404.csv', skiprows=4)
